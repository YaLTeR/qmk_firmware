...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
    ...
    KC_ESC,  MSP_AGR, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_NO,   RAISE,   KC_LGUI,  KC_LBRC, KC_RBRC, KC_ENT
  ),
  ...
  [_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, KC_NO,   _______, _______, KC_MS_L, KC_MS_D, KC_MS_R
  ),
